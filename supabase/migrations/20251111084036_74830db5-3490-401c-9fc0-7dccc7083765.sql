...
DROP POLICY IF EXISTS "Artisans can create their own products" ON public.products;
...
DROP POLICY IF EXISTS "Artisans can update their product images" ON storage.objects;
